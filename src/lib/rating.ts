 ...
 *
 * Specifikacijoje — 4, bet kol turnyrų mažai, laikom 3. Visa kita (vietų
 * numeracija, "dar N iki lentelės" užrašas) prisitaiko savaime.
 */
export const MIN_TOURNAMENTS_PUBLIC = 3;
